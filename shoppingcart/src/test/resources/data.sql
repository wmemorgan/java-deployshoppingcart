...
INSERT INTO USERS(USERID, USERNAME, PASSWORD, COMMENTS, CREATED_BY, CREATED_DATE, LAST_MODIFIED_BY, LAST_MODIFIED_DATE)
     VALUES (1, 'testbarnbarn', '$2y$12$3jkQBYZpeKKDSDA1Ws1uzuhIAztEnI8UyRZHQ98pTij7xxp6RtlI2', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (2, 'testcinnamon', '$2y$12$5EhoDOj2oGGEhmW8UFwh6e5an6WZ/IaoDPCux0oN4x4pwLm0pj6lq', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (3, 'teststumps', '$2y$12$1J5duOYDY4qZZfkOSQwSi.kps8UdatRiw835XN6TL4Vw6f6ioVFBW', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP);
